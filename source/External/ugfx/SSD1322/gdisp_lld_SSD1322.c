...
LLDSPEC gBool gdisp_lld_init(GDisplay *g)
{
    ...
    write_data(g,
               0x06);    //Horizontal address increment,Disable Column Address Re-map,Enable Nibble Re-map,Scan from COM[N-1] to COM0,Disable COM Split Odd Even
    ...
    write_data(g, 0x005 | 0x0fd);//	0xfd,Enhanced low GS display quality;default is 0xb5(normal),
