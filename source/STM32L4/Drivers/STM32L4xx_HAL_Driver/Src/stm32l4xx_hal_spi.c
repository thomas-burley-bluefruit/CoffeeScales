...
SPI_WaitFlagStateUntilTimeout(SPI_HandleTypeDef *hspi, uint32_t Flag, FlagStatus State,
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_SPI_TransmitReceive_IT(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData,
                           uint16_t Size)
{
    uint32_t tmp_mode;
    HAL_SPI_StateTypeDef tmp_state;
